...
void test_detector_cpu(char **names, char *cfgfile, char *weightfile, char *filename, float thresh, int quantized, int save_params, int dont_show)
{
...
void run_detector(int argc, char **argv)
{
    ...
    if (0 == strcmp(argv[2], "test")) test_detector_cpu(names, cfg, weights, filename, thresh, quantized, save_params, dont_show);
